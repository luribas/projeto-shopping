...
public class ControllerPedido {
	...
	public void fazerPagamento() {
		...
		System.out.println(" * * * * * * * * * * * * * * * * * * * * * * * * * *");
		System.out.println("  Escolha o tipo de pagamento: ");
		System.out.println("  1 - Cartï¿½o de Crï¿½dito");
		System.out.println("  2 - Cartï¿½o de Dï¿½bito");
		System.out.println("  3 - Dinheiro");
		System.out.print("  -> ");
		int opPagamento = scanner.nextInt();
		switch (opPagamento) {
			case 1 :
				System.out.println("\n * * * * * * * * * * * * * * * * * * * * * * * * * *");
				System.out.println(" *           PAGAMENTO CARTï¿½O DE CRï¿½DITO           *");
				System.out.println(" * * * * * * * * * * * * * * * * * * * * * * * * * *");
				String dxValorTotal = df.format(p.getValorTotal());
			...
			case 2 :
				System.out.println("\n * * * * * * * * * * * * * * * * * * * * * * * * * *");
				System.out.println(" *         PAGAMENTO CARTï¿½O DE Dï¿½BITO              *");
				System.out.println(" * * * * * * * * * * * * * * * * * * * * * * * * * *");
				String dxDebito = df.format(p.getValorTotal());
				System.out.println("  Valor total a pagar: R$" + dxDebito);
				System.out.println("\n  * Favor pagar no caixa. *");
			...
			case 3 :
				...
				double valorPagar = 0;
				do {
					System.out.print("\n  Qual o valor serï¿½ pago? R$");
					valorPagar = scanner.nextDouble();
				
					if (valorPagar < p.getValorTotal()) {
						System.out.println("\n Esse valor ï¿½ menor que o total a pagar! \n Tente novamente. ");
					} else {
						double troco = valorPagar - p.getValorTotal();
						String dx = df.format(troco);
						System.out.print("\n  -> Seu troco serï¿½: R$" + dx);
